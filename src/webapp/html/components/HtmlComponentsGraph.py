...
class HtmlComponentsGraph(object):
    ...
    def graph(base_url, align_form, PREFIX_UI_CTRLS_GRAPH, maps_config):
        ...
        <section id="content">
            ...
            """.format(base_url+"/mapmarkers/graph"))
        
        output.append(HtmlComponentsBase._load_query_area_graph(align_form.get_query(),
                                                align_form.get_user_file(),
                                              "Input FASTA nucleotide sequences (1-word header):",
                                              PREFIX_UI_CTRLS_GRAPH))
        output.append("<br/>")
        ...
        output.append(HtmlComponentsBase._load_graph_alignment_area( 
        ...
        output.append("""
                ...
                <td>
                    ...
                    <legend style="text-align:left;">Choose graph:</legend>
                    """)
