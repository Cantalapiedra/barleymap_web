                    ...
                    <h2 id="align_sequences">Align sequences</h2>
                        ...
                        <ul class="help_list">
                            ...
                            <li><strong>MorexV3</strong><sup>[4]</sup></li>
                                ...
                                MorexV3 is the default genome assembly and most of the datasets precomputed in Barleymap web
                                are available for this reference. It also serves as the annotated reference used to build the pangenome graphs
                                Pan20 and Med13.<br/><br/>

                                In addition, we offer <strong>pangenome graphs</strong> with MorexV3 global coordinates. 
                                These can be built with different settings (mmap vs gmap, geno vs pro) and the following assemblies:<br/><br/>
                                <strong>Pan20</strong>: <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=b8a0d6158b9961df&folder_ids=">Akashinriki</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=0d16186aaff7cbfd&folder_ids=">B1K-04-12</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=6d4c8d216c52b289&folder_ids=">Barke</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=68013dab1c13fb37&folder_ids=">Chiba</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=6d9affd96770ffb9&folder_ids=">Du_Li_Huang</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=0998682e795f41c2&folder_ids=">GoldenPromise</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=f30a35c999095ed7&folder_ids=">Hockett</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=9b5c597dcbb59371&folder_ids=">HOR_10350</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=c08f58209a47fe2d&folder_ids=">HOR_13821</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=59606d2a36c77a56&folder_ids=">HOR_13942</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=3f00d864a8cefbf4&folder_ids=">HOR_21599</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=fbff8f73b82d1777&folder_ids=">HOR_3081</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=b2486a20bc56b90f&folder_ids=">HOR_3365</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=83e633fc7a5c928a&folder_ids=">HOR_7552</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=795b4cb2a2107ba7&folder_ids=">HOR_8148</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=c86c1b73aa7102dd&folder_ids=">HOR_9043</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=1ac3b66e11b8fe50&folder_ids=">Igri</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=e2132aef71b11dbf&folder_ids=">OUN333</a>, <a href="https://galaxy-web.ipk-gatersleben.de/api/libraries/datasets/download/uncompressed?ld_ids=0d72ca01c763d02d&folder_ids=">Planet</a>
                                <br/><br/>
<!--                            <strong>Med13</strong>: <a href="https://www.ebi.ac.uk/ena/browser/api/fasta/GCA_949783365.1?download=true&gzip=true">HOR_14121</a>, <a href="https://www.ebi.ac.uk/ena/browser/api/fasta/GCA_949783375.1?download=true&gzip=true">HOR_21595</a>, <a href="https://www.ebi.ac.uk/ena/browser/api/fasta/GCA_949783475.1?download=true&gzip=true">HOR_3474</a>, <a href="https://www.ebi.ac.uk/ena/browser/api/fasta/GCA_949783295.1?download=true&gzip=true">HOR_13942</a>, <a href="https://www.ebi.ac.uk/ena/browser/api/fasta/GCA_949783435.1?download=true&gzip=true">HOR_21599</a>, <a href="https://www.ebi.ac.uk/ena/browser/api/fasta/GCA_949783415.1?download=true&gzip=true">HOR_3365</a>, <a href="https://www.ebi.ac.uk/ena/browser/api/fasta/GCA_949783545.1?download=true&gzip=true">HOR_2830</a>, <a href="https://www.ebi.ac.uk/ena/browser/api/fasta/GCA_949783585.1?download=true&gzip=true">HOR_10892</a>, <a href="https://www.ebi.ac.uk/ena/browser/api/fasta/GCA_949783485.1?download=true&gzip=true">HOR_2779</a>, <a href="https://www.ebi.ac.uk/ena/browser/api/fasta/GCA_949783555.1?download=true&gzip=true">HOR_1168</a>, <a href="https://www.ebi.ac.uk/ena/browser/api/fasta/GCA_949783505.1?download=true&gzip=true">HOR_12184</a><br/><br/> -->
                                <!-- TODO GDB136-->

                                <img src="{0}/img/Pan20_minimap_proali.png" alt="Pan20 summary"/> 

                            <li><strong>Morex Genome</strong><sup>[3]</sup></li>
                                <br/>
                                
                                The Morex Genome is a genome assembly older than MorexV3. Most of the datasets precomputed in Barleymap web
